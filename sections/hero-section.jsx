    ...
    return (
        <section className="flex flex-col items-center -mt-18">
            ...
            >
                ...
                <span>Bring your idea to life</span>
            </motion.a>
            ...
            >
            I’m<span className="bg-gradient-to-r from-white to-[#372AAC] bg-clip-text text-transparent font-semibold">Umair</span>, building web experiences.
            </motion.h1>
            <motion.p className="text-center text-base max-w-lg mt-2"
                ...
                transition={{ delay: 0.2, type: "spring", stiffness: 320, damping: 70, mass: 1 }}
            >
                Delivering polished digital experiences through modern tools, attention to detail, and purposeful development.
            </motion.p>
            <motion.div className="flex items-center gap-4 mt-8"
               ...
               <a
   href="/assets/updated%20Resume.pdf"
  target="_blank"
